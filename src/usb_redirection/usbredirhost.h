/* usbredirhost.c usb network redirection usb host code header
   ...
   UPDATE: В msys какая-то забаганная версия usbredirhost, поэтому берем с собой последнюю с репы usb
*/
#ifndef VEIL_CONNECT_USBREDIRHOST_H
#define VEIL_CONNECT_USBREDIRHOST_H
