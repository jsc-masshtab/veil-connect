...
pipeline {
    ...
    parameters {
        ...
        string(      name: 'VERSION',              defaultValue: '1.2.16',          description: 'version')
                ...
                stage ('windows-x32. copy dependencies') {
                    ...
                    steps {
                        bat script: '''
                            ...
                            for %%I in (libatk-1.0-0 libbz2-1 libcairo-2 libcairo-gobject-2 libcares-3 libcroco-0.6-3 libcrypto-1_1 ^
                            ...
                            libsource-highlight-4 libspice-client-glib-2.0-8 libspice-client-gtk-3.0-5 libsqlite3-0 libsquish libssh2-1 libssl-1_1 ^
