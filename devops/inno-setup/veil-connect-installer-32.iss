...
AppId={{60C768F1-3FE9-4C8E-A9A2-0EE659FDB2BB}
AppName={#MyAppName}
...
Source: "C:\Jenkins\workspace\veil-connect-win\build\gspawn-win32-helper*.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
